...
# character is capitalized, and the remaining characters 
# are lowercase. Characters that are not letters should 
# not be changed, but count as characters when switching 
